...
@Configuration
@ComponentScan({"com.itisacat.algo"})
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.itisacat.algo");
                servletContext.setInitParameter("tapestry.development-modules", "com.itisacat.algo.services.DevelopmentModule");
